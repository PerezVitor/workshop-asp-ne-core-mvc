...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", 1000.00, new DateTime(1998, 4, 21), d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 2200.00, new DateTime(1978, 10, 17), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 1600.00, new DateTime(1982, 11, 7), d2);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 1150.00, new DateTime(1996, 12, 31), d3);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 1385.00, new DateTime(1999, 1, 12), d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexpk@gmail.com", 2158.00, new DateTime(1986, 6, 15), d4);
